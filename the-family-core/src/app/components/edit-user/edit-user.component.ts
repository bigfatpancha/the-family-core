...
export class EditUserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.newUserForm = new FormGroup({
      ...
      colorCode: new FormControl(
        this.user.colorCode && this.user.colorCode !== 'null'
          ? this.user.colorCode
          : null
      ),
      ...
      middleName: new FormControl(
        this.user.middleName && this.user.middleName !== 'null'
      ...
      mobileNumber: new FormControl(
        this.user.mobileNumber && this.user.mobileNumber !== 'null'
      ...
      height: new FormControl(
        this.user.height && this.user.height !== 'null'
          ? this.user.height
          : null,
        [Validators.maxLength(30)]
      ),
      weight: new FormControl(
        this.user.weight && this.user.weight !== 'null'
          ? this.user.weight
          : null,
        [Validators.maxLength(30)]
      ),
      hairColor: new FormControl(
        this.user.hairColor && this.user.hairColor !== 'null'
          ? this.user.hairColor
          : null,
        [Validators.maxLength(30)]
      ),
      eyeColor: new FormControl(
        this.user.eyeColor && this.user.eyeColor !== 'null'
          ? this.user.eyeColor
          : null,
        [Validators.maxLength(30)]
      ),
      bloodType: new FormControl(
        this.user.bloodType && this.user.bloodType !== 'null'
          ? this.user.bloodType
          : null,
        [Validators.maxLength(30)]
      ),
      countryOfCitizenship: new FormControl(
        this.user.countryOfCitizenship &&
        this.user.countryOfCitizenship !== 'null'
          ? this.user.countryOfCitizenship
          : null,
        [Validators.maxLength(30)]
      ),
      passportNumber: new FormControl(
        this.user.passportNumber && this.user.passportNumber !== 'null'
          ? this.user.passportNumber
          : null,
        [Validators.maxLength(30)]
      ),
      socialSecurityNumber: new FormControl(
        this.user.socialSecurityNumber &&
        this.user.socialSecurityNumber !== 'null'
          ? this.user.socialSecurityNumber
          : null,
        [Validators.maxLength(30)]
      ),
      schoolState: new FormControl(
        this.user.schoolState && this.user.schoolState !== 'null'
          ? this.user.schoolState
          : null,
        [Validators.maxLength(30)]
      ),
      school: new FormControl(
        this.user.school && this.user.school !== 'null'
          ? this.user.school
          : null,
        [Validators.maxLength(30)]
      ),
      grade: new FormControl(
        this.user.grade && this.user.grade !== 'null' ? this.user.grade : null,
        [Validators.maxLength(30)]
      ),
      topSize: new FormControl(
        this.user.topSize && this.user.topSize !== 'null'
          ? this.user.topSize
          : null,
        [Validators.maxLength(30)]
      ),
      bottomsSize: new FormControl(
        this.user.bottomsSize && this.user.bottomsSize !== 'null'
          ? this.user.bottomsSize
          : null,
        [Validators.maxLength(30)]
      ),
      shoeSize: new FormControl(
        this.user.shoeSize && this.user.shoeSize !== 'null'
          ? this.user.shoeSize
          : null,
        [Validators.maxLength(30)]
      ),
      braSize: new FormControl(
        this.user.braSize && this.user.braSize !== 'null'
          ? this.user.braSize
          : null,
        [Validators.maxLength(30)]
      ),
      shirtSize: new FormControl(
        this.user.shirtSize && this.user.shirtSize !== 'null'
          ? this.user.shirtSize
          : null,
        [Validators.maxLength(30)]
      ),
      pantsSize: new FormControl(
        this.user.pantsSize && this.user.pantsSize !== 'null'
          ? this.user.pantsSize
          : null,
        [Validators.maxLength(30)]
      ),
      allergies: new FormControl(
        this.user.allergies ? this.user.allergies[0] : null,
      ...
      adminNotes: new FormControl(
        this.user.adminNotes && this.user.adminNotes !== 'null'
          ? this.user.adminNotes
          : null
      ),
      addressLine1: new FormControl(
        this.user.address
          ? this.user.address.addressLine1 &&
            this.user.address.addressLine1 !== 'null'
            ? this.user.address.addressLine1
            : null
          : null,
        [Validators.maxLength(128)]
      ...
      addressLine2: new FormControl(
        this.user.address
          ? this.user.address.addressLine2 &&
            this.user.address.addressLine2 !== 'null'
            ? this.user.address.addressLine2
            : null
          : null,
        [Validators.maxLength(128)]
      ...
      city: new FormControl(
        this.user.address
          ? this.user.address.city && this.user.address.city !== 'null'
      ...
      zipCode: new FormControl(
        this.user.address
          ? this.user.address.zipCode && this.user.address.zipCode !== 'null'
      ...
      state: new FormControl(
        this.user.address
          ? this.user.address.state && this.user.address.state !== 'null'
      ...
      phoneNumber: new FormControl(
        this.user.address
          ? this.user.address.phoneNumber &&
            this.user.address.phoneNumber !== 'null'
            ? this.user.address.phoneNumber
            : null
          : null,
        [Validators.maxLength(128)]
      ...
      faxNumber: new FormControl(
        this.user.address
          ? this.user.address.faxNumber &&
            this.user.address.faxNumber !== 'null'
            ? this.user.address.faxNumber
            : null
          : null,
        [Validators.maxLength(128)]
      ...
      refName: new FormControl(
        this.user.referredBy ? this.user.referredBy.name : null,
        [Validators.maxLength(30)]
      ),
      refColorCode: new FormControl(
        this.user.colorCode && this.user.colorCode !== 'null'
          ? this.user.colorCode
          : null
      ),
      driversLicenseState: new FormControl(
        this.user.referredBy &&
      ...
      refplaceOfBirth: new FormControl(
        this.user.referredBy &&
        this.user.referredBy.placeOfBirth !== 'undefined'
          ? this.user.referredBy.placeOfBirth
          : null,
        [Validators.maxLength(30)]
      ),
      refpassportNumber: new FormControl(
        this.user.referredBy &&
      ...
      relationships: new FormControl(this.user.relationships, [
        Validators.maxLength(30)
      ])
    });
  ...
  saveUser() {
    if (this.newUserForm.status === 'VALID') {
      ...
      if (this.selectedRelationships) {
        this.editedUser.relationships = this.selectedRelationships.map(
          item => item.id
        );
      }
      if (this.role.dirty) {
      ...
      this.usersService.doUserIdPatch(this.user.id, this.editedUser).subscribe(
        (data: User) => {
          this.spinner.hide();
  ...
  isAddressEdited(): boolean {
    return (
      this.addressLine1.dirty ||
      this.addressLine2.dirty ||
      this.city.dirty ||
      this.faxNumber.dirty ||
      this.phoneNumber.dirty ||
      this.state.dirty ||
      this.zipCode.dirty
    );
  }
  ...
  isRefEdited(): boolean {
    return (
      this.refName.dirty ||
      this.refColorCode.dirty ||
      this.driversLicenseState.dirty ||
      this.driversLicenseNumber.dirty ||
      this.refCountOfCit.dirty ||
      this.agency.dirty ||
      this.passportNumber.dirty ||
      this.refplaceOfBirth.dirty ||
      this.refSocSecNum.dirty
    );
  }
}
