...
export class UploadComponent implements OnInit {
  ...
  postEvent() {
    ...
    this.eventsService.doEventPost(event).subscribe(
      (res: Event) => {
        this.spinner.hide();
  ...
  postDocument() {
    ...
    this.documentsService.doDocumentPost(document).subscribe(
      (res: Document) => {
        this.spinner.hide();
        this.onEventPost.emit(true);
        this.dialogRef.close();
  ...
  postContact() {
    ...
    this.contactsService.doContactsPost(contact).subscribe(
      (res: Contact) => {
        this.spinner.hide();
        this.onEventPost.emit(true);
        this.dialogRef.close();
